...
function App ({ saludo, nombre }) {
  return (
    <>
      <HeaderHero title='Bienvenidos' desc='Estamos haciendo un header que recibe props' buttonText='Conoce mas' buttonLink='https://alexcgdesign.com/blog/crea-una-pagina-web-desde-cero-con-html-css/' />
      <section className='wave-contenedor website' />
      <HeaderHero title='Se un RockStar en coding' desc='Este es un segundo header' buttonText='Otro link' buttonLink='https://alexcgdesign.com/blog/crea-una-pagina-web-desde-cero-con-html-css/' />
      <section className='wave-contenedor website'>
